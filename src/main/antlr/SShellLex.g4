...
D_Assn : IDENTIFIER EQ
	{ setText(getText().substring(0, getText().length() - 1)); }
	-> type(Assn), mode(ASSIGN_MODE);

D_Escaped : ESCAPE .
	{ setText(getText().substring(1)); }
	-> type(String), mode(SECOND_TOKEN_MODE);
D_Subst : DOL IDENTIFIER
	{ setText(getText().substring(1)); }
	-> type(Subst), mode(SECOND_TOKEN_MODE);
D_HardQuote : HARD_QUOTE NOT_HARD_QUOTE* HARD_QUOTE
...
ST_Escaped : ESCAPE .
	{ setText(getText().substring(1)); }
	-> type(String);
ST_Subst : DOL IDENTIFIER
	{ setText(getText().substring(1)); }
	-> type(Subst);
ST_HardQuote : HARD_QUOTE NOT_HARD_QUOTE* HARD_QUOTE
	{ setText(getText().substring(1, getText().length() - 1)); }
	-> type(String);
...
A_Escaped : ESCAPE .
	{ setText(getText().substring(1)); }
	-> type(String);
A_Subst : DOL IDENTIFIER
	{ setText(getText().substring(1)); }
	-> type(Subst);
A_HardQuote : HARD_QUOTE NOT_HARD_QUOTE* HARD_QUOTE
	{ setText(getText().substring(1, getText().length() - 1)); }
	-> type(String);
...
SQ_Escaped : ESCAPE SQ_SPECIAL
	{ setText(getText().substring(1)); }
	-> type(String);
SQ_Subst : DOL IDENTIFIER
	{ setText(getText().substring(1)); }
	-> type(Subst);
